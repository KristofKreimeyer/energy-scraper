...
function App() {
  ...
  return (
    <>
      ...
      <main id="main">
        ...
        >
          ...
          <p className="text-muted text-[1.02rem] max-w-[56ch]">
            ...
            Netto, Penny und Rewe. Vergleiche Dosenpreis <em>und</em> Grundpreis
            auf einen Blick.
          </p>
        ...
        <div className={WRAP}>
          <p
            ...
            aria-live="polite"
          >
            <b className="text-ink">{visible.length}</b>{" "}
            {visible.length === 1 ? "Angebot" : "Angebote"} · sortiert nach{" "}
            {SORT_LABELS[sort]}
            {filtersActive && (
              <>
                {" · "}
      ...
      {showFilters && (
        <Modal onClose={() => setShowFilters(false)} label="Anzeige anpassen">
